    ...
    public abstract class ObjectGraphNode : Node {
        ...
        private void ConfigureInputPort(Type type) {
            ...
            if (inputPort == null) {
                ...
                inputPort = PortUtility.Create(type == null ? null : GetPortType(type), "In", Direction.Input, Port.Capacity.Multi, GetPortColor(type));
        ...
        private void ConfigureOutputPort(Type type) {
            ...
            if (outputPort == null) {
                outputPort = PortUtility.Create(type == null ? null : GetPortType(type), "Out", Direction.Output, Port.Capacity.Single, GetPortColor(type));
