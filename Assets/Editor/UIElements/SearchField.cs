...
namespace Reactics.Editor {
    ...
    public abstract class SearchField<TObject> : BindableElement, INotifyValueChanged<TObject> {
        ...
        protected class SearchFieldResults : VisualElement {
            ...
            private void OnSearchResultSelect(MouseDownEvent evt) {
                ...
                if (evt.target is SearchResultElement<TObject> visualElement) {
                    searchField.selectedResult = visualElement.Value;
    ...
    public interface ISearchResult<TObject> {
        SearchResultElement<TObject> CreateElement();
        TObject LoadValue();
        string DisplayText { get; }
    }
    public abstract class SearchResultElement<TObject> : VisualElement {
        public abstract ISearchResult<TObject> Value { get; set; }
    }
}