...
namespace Reactics.Core.UI {
    ...
    public struct SimpleValueProperties : IValueProperties {
    ...
    public static class UILengthExtensions {
        ...
        public static float4 RealValues<TProperties>(this UILength4 self, TProperties properties = default) where TProperties : struct, IValueProperties {
            return new float4(self.Top.RealValue(properties, UILength.Hints.Vertical),
            self.Right.RealValue(properties, UILength.Hints.Horizontal),
            self.Bottom.RealValue(properties, UILength.Hints.Vertical),
            self.Left.RealValue(properties, UILength.Hints.Horizontal)
            );
        }
    }
    ...
    public struct UILength4 : IBox {

        private UILength top;
        public UILength Top { get => top; set => top = value; }
        private UILength right;
        public UILength Right { get => right; set => right = value; }
        private UILength bottom;
        public UILength Bottom { get => bottom; set => bottom = value; }
        private UILength left;
        public UILength Left { get => left; set => left = value; }
    }
    ...
    public static class IVersionExtensions {
        public static TVersion Update<TVersion>(this TVersion self) where TVersion : struct, IVersion {
            self.Version++;
            return self;
        }
    }
