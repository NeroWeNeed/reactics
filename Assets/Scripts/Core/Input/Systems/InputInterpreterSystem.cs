    ...
    public class InputInterpreterSystem : ComponentSystem {
        protected override void OnUpdate() {
            ...
            if (inputData.currentActionMap == ActionMaps.BattleControls) {
                ...
                bool selectTileInput = !cancelTileInput && input.BattleControls.SelectTile.triggered;
            ...
            //Receive command controls inputs only.
                ...
                bool selectActionInput = !cancelActionInput && input.CommandControls.SelectAction.triggered;
                bool menuMovementInput = !cancelActionInput && input.CommandControls.MenuMovement.triggered;
