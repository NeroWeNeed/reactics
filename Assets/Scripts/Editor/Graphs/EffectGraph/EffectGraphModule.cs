...
namespace Reactics.Editor.Graph {
    public class EffectGraphModule : BaseObjectGraphNodeModule<EffectGraphNode>, IObjectGraphPostDeserializerCallback, IObjectGraphPreSerializerCallback, IObjectGraphValidator {
