...
namespace NeroWeNeed.UIDots.Editor {
    public interface IUIPropertyWriter {
        ...
        void Write(string s, IntPtr ptr, TypeDecomposer.FieldData fieldData, MemoryBinaryWriter extraBytesStream, long extraByteStreamOffset, UIPropertyWriterContext context);
    }
